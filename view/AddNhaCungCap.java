...
public class AddNhaCungCap extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
            ...
            if (maNcc.isEmpty() || tenNcc.isEmpty() || diachiNcc.isEmpty()) {
            ...
            if (sdtNcc.length() < 10 || sdtNcc.length() > 11) {
                JOptionPane.showMessageDialog(this, "Số điện thoại phải là 10 hoặc 11 chữ số!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                return;
            }
