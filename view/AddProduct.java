...
public class AddProduct extends javax.swing.JDialog {
    ...
    if (tenMay.length() > 50) {
        JOptionPane.showMessageDialog(this, "Tên sản phẩm không được vượt quá 50 kí tự!");
        txtTenSanPham.requestFocus();
        return;
    }
    ...
    // CPU
    if (cpu.isEmpty()) {
        JOptionPane.showMessageDialog(this, "CPU không được để trống!");
        txtCPU.requestFocus();
        return;
    }
    if (!cpu.matches("[\\p{L}\\p{N} .+\\-]+")) {
        JOptionPane.showMessageDialog(this, "CPU không được chứa ký tự đặc biệt!");
        txtCPU.requestFocus();
        return;
    }
    ...
    // ROM
    if (rom.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Dung lượng lưu trữ không được để trống!");
        txtROM.requestFocus();
        return;
    }
    int romValue;
    try {
        romValue = Integer.parseInt(rom);
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Dung lượng lưu trữ phải là số nguyên!");
        txtROM.requestFocus();
        return;
    }
    if (romValue < 16 || romValue > 2048) {
        JOptionPane.showMessageDialog(this, "Dung lượng lưu trữ phải trong khoảng 16 - 2048GB!");
        txtROM.requestFocus();
        return;
    }
    ...
    // GPU
    if (gpu.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Card đồ họa không được để trống!");
        txtGPU.requestFocus();
        return;
    }
    if (gpu.length() < 3 || gpu.length() > 50) {
        JOptionPane.showMessageDialog(this, "Card đồ họa phải từ 3-50 kí tự!");
        txtGPU.requestFocus();
        return;
    }
    ...
    // Xuất xứ
    if (xuatxu.length() > 50) {
        JOptionPane.showMessageDialog(this, "Xuất xứ không được vượt quá 50 kí tự!");
    ...
    if (cbxloaisp.getSelectedItem().equals("Laptop")) {
        ...
        // Kích thước màn: số + khoảng 10–40 inch
        try {
            ...
            txtKichThuocMan.requestFocus();
            return;
        }
        if (kichthuocman < 10 || kichthuocman > 40) {
            JOptionPane.showMessageDialog(this, "Kích thước màn phải trong khoảng 10 - 40 inch!");
            txtKichThuocMan.requestFocus();
            return;
        }

        // Dung lượng pin: bắt buộc, số nguyên, 1000–10000 mAh
        String dungluongpin = txtDungLuongPin.getText().trim();
        if (dungluongpin.isEmpty()) {
        ...
        int pinValue;
        try {
            pinValue = Integer.parseInt(dungluongpin);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Dung lượng PIN phải là số nguyên!");
            txtDungLuongPin.requestFocus();
            return;
        }
        if (pinValue < 1000 || pinValue > 10000) {
            JOptionPane.showMessageDialog(this, "Dung lượng PIN phải trong khoảng 1000 - 10000 mAh!");
            txtDungLuongPin.requestFocus();
            return;
        }
    ...
    if (cbxloaisp.getSelectedItem().equals("PC")) {
        ...
        if (mainboard.isEmpty()) {
            JOptionPane.showMessageDialog(this, "MainBoard không được để trống!");
            txtMainBoard.requestFocus();
            return;
        }
