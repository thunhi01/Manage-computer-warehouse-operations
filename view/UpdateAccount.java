...
public class UpdateAccount extends javax.swing.JDialog {
    ...
    private void btnupdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnupdateActionPerformed
        ...
        if (trimedEmail.length()>50){
            JOptionPane.showMessageDialog(this, "Email quá dài\n" + "-Độ dài tối đa 50 kí tự.", "Lỗi", JOptionPane.ERROR_MESSAGE);
            txtEmail.requestFocus();
            return;
        }
        if (!trimedEmail.matches("^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,}$")){
